...
const COURSES: Course[] = [
  ...
  },
  {
    ...
    description: 'Kelas ini membekali kamu dengan kemampuan merancang, menjalankan, dan mengoptimalkan iklan Meta (Facebook & Instagram) dari nol hingga mahir. Mulai dari riset audiens, pembuatan creative brief, sampai analisis performa iklan.',
    topics: [
...
const TESTIMONIALS = [
  {
    ...
    after: 'Bisa bikin konten 10x lebih cepat pake AI',
    company: 'Freelancer',
    quote: 'Dulu 1 hari cuma bisa bikin 1 artikel. Sekarang 10 artikel dalam 2 jam. Luar biasa!',
  },
  {
    name: 'Siti Nurhaliza',
