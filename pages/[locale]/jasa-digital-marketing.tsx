...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-sosmed/1',
  en: '/en/lp/jasa-sosmed/1',
};
...
export default function JasaDigitalMarketingRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Digital Marketing | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
