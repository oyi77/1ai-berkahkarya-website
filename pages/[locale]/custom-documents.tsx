...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/custom-documents/1',
  en: '/en/lp/custom-documents/1',
};
...
export default function CustomDocumentsRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Custom Documents | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
