...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/ai-automation/1',
  en: '/en/lp/ai-automation/1',
};
...
export default function AiAutomationRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — AI Automation | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
