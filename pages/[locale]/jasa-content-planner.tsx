...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-content-planner/1',
  en: '/en/lp/jasa-content-planner/1',
};
...
export default function JasaContentPlannerRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Content Planner | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
