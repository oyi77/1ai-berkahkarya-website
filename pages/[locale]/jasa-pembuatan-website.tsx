...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-website/1',
  en: '/en/lp/jasa-website/1',
};
...
export default function JasaPembuatanWebsiteRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Pembuatan Website | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
