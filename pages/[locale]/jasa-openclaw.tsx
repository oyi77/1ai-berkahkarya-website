...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-openclaw/1',
  en: '/en/lp/jasa-openclaw/1',
};
...
export default function JasaOpenclawRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa OpenClaw | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
