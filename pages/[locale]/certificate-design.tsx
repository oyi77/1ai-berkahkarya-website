...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/certificate-design/1',
  en: '/en/lp/certificate-design/1',
};
...
export default function CertificateDesignRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Certificate Design | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
