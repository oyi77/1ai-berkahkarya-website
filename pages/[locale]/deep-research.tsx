...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/deep-research/1',
  en: '/en/lp/deep-research/1',
};
...
export default function DeepResearchRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Deep Research | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
