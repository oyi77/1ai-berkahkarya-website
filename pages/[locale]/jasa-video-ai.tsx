...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-video-ai/1',
  en: '/en/lp/jasa-video-ai/1',
};
...
export default function JasaVideoAiRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Video AI | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
