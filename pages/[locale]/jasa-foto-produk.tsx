...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-foto-produk/1',
  en: '/en/lp/jasa-foto-produk/1',
};
...
export default function JasaFotoProdukRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Foto Produk | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
