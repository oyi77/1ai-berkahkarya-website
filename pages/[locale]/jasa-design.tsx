...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/jasa-design/1',
  en: '/en/lp/jasa-design/1',
};
...
export default function JasaDesignRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Jasa Design | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
