...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/video-production/1',
  en: '/en/lp/video-production/1',
};
...
export default function VideoProductionRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — Video Production | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
