...
const LP_ROUTE: Record<Locale, string> = {
  id: '/id/lp/ai-agent-pro/1',
  en: '/en/lp/ai-agent-pro/1',
};
...
export default function AiAgentProRedirect({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      <Head>
        ...
        <title>Redirecting — AI Agent Pro | BerkahKarya</title>
      </Head>
      <div style={{
        display: 'flex',
        minHeight: '100vh',
