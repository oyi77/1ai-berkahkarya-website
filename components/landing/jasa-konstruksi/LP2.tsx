  ...
  return (
    ...
    >
      <div className={b.wrapper}>
          ...
          <div className={b.container}>
            <div className={b.statsRow}>
              <div className={b.stat}>
                <div className={b.statNum}>10+</div>
                <div className={b.statLabel}>{locale === 'en' ? 'Years Experience' : 'Tahun Pengalaman'}</div>
              </div>
              <div className={b.stat}>
                <div className={b.statNum}>100+</div>
                <div className={b.statLabel}>{locale === 'en' ? 'Projects Done' : 'Proyek Terselesaikan'}</div>
              </div>
              <div className={b.stat}>
                <div className={b.statNum}>98%</div>
                <div className={b.statLabel}>{locale === 'en' ? 'Client Satisfied' : 'Client Puas'}</div>
              </div>
              <div className={b.stat}>
                <div className={b.statNum}>{locale === 'en' ? 'Free' : 'Gratis'}</div>
                <div className={b.statLabel}>{locale === 'en' ? 'Consultation & Design' : 'Konsultasi & Desain'}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Services Section */}
        <section className={b.section} style={{ background: 'var(--dark-hero)' }}>
          <div className={b.container}>
            <span className={b.eyebrow}>{locale === 'en' ? 'Our Services' : 'Layanan Kami'}</span>
            <h2 className={b.sectionTitle}>
              {locale === 'en' ? 'We Handle It ' : 'Kami Urus Semua, '}
              <span className={b.gradientText}>{locale === 'en' ? 'All Under One Roof' : 'Satu Atap'}</span>
            </h2>
        ...
        <section className={b.section}>
          <div className={b.container}>
            <span className={b.eyebrow}>{locale === 'en' ? 'Client Testimonial' : 'Testimoni Client'}</span>
            <h2 className={b.sectionTitle}>
              {locale === 'en' ? 'What Our ' : 'Kata '}
              <span className={b.gradientText}>{locale === 'en' ? 'Clients Say' : 'Mereka'}</span>
            </h2>
            <div style={{ maxWidth: '700px', margin: '0 auto' }}>
              <div className={b.testiCard}>
                ...
                <div className={b.testiAuthor}>
                  <div className={b.testiAvatar}>BS</div>
                  <div>
        ...
        <section className={b.finalCta}>
          <div className={b.container}>
            <h2 className={b.sectionTitle}>
              ...
              <span className={b.gradientText}>{locale === 'en' ? 'Free Consultation?' : 'Konsultasi Dulu?'}</span>
            </h2>
            <p className={b.subtitle}>
              {locale === 'en'
