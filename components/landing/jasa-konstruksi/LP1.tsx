  ...
  return (
    ...
    >
      <div className={b.wrapper}>
        ...
        <section className={b.hero}>
          <div className={b.heroInner}>
            ...
            <h1 className={b.title}>
              ...
              <span className={b.gradientText}>{locale === 'en' ? 'Without the Headache' : 'Tanpa Pusing Mikirin Detail'}</span>
            </h1>
        ...
        <section className={b.section}>
          <div className={b.container}>
            ...
            <h2 className={b.sectionTitle}>
              ...
              <span className={b.gradientText}>{locale === 'en' ? 'Worry About Construction' : 'Takut Bangun Rumah?'}</span>
            </h2>
        ...
        <section className={b.section}>
          <div className={b.container}>
            <span className={b.eyebrow}>{locale === 'en' ? 'Our Promise' : 'Yang Kami Berikan'}</span>
            <h2 className={b.sectionTitle}>
              {locale === 'en' ? 'Everything You Need ' : 'Semua yang Anda Butuhkan '}
              <span className={b.gradientText}>{locale === 'en' ? 'In One Package' : 'Dalam Satu Paket'}</span>
            </h2>
        ...
        <section className={b.finalCta}>
          <div className={b.container}>
            <h2 className={b.sectionTitle}>
              ...
              <span className={b.gradientText}>{locale === 'en' ? 'Your Dream Home?' : 'Rumah Impian?'}</span>
            </h2>
            <p className={b.subtitle}>
              {locale === 'en'
