    ...
    >
      <div className={b.wrapper}>
        ...
        <section className={b.hero}>
          <div className={b.heroInner}>
            ...
            <h1 className={b.title}>
              ...
              <span className={b.gradientText}>{locale === 'en' ? 'Upload' : 'Upload Doang'}</span>
            </h1>
        ...
        <section className={b.section}>
          <div className={b.container}>
            <span className={b.eyebrow}>{locale === 'en' ? 'Output' : 'Output'}</span>
            <h2 className={b.sectionTitle}>
              {locale === 'en' ? (
                <>Upload 1 Photo, <span className={b.gradientText}>Get These 4</span></>
              ) : (
                <>Upload 1 Foto, <span className={b.gradientText}>Dapat 4 Ini</span></>
              )}
            </h2>
            ...
            <div className={b.grid4}>
              ...
              <div className={b.card}>
                <div className={b.cardIcon}>#️⃣</div>
        ...
        <section className={b.finalCta}>
          <div className={b.container}>
            <h2 className={b.sectionTitle}>
              {locale === 'en' ? (
                <>Want It <span className={b.gradientText}>Easy?</span></>
              ) : (
                <>Mau Yang <span className={b.gradientText}>Gampang?</span></>
              )}
            </h2>
            <p className={b.subtitle}>{locale === 'en' ? '3 free credits. Try it now.' : '3 kredit gratis. Langsung cobain.'}</p>
            <TrackedCTA
              href="https://saas.aitradepulse.com/"
              className={b.btnPrimary}
