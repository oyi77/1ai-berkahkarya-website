...
export const ecosystemData: Record<string, {
  ...
  id: {
    meta: {
      ...
      description: '5 layanan AI yang membangun, menjalankan, dan mengembangkan bisnis BerkahKarya secara otomatis. Dari AI orchestration hingga workflow automation — semuanya buatan 1 orang.',
    },
    hero: {
    ...
    items: [
      {
        ...
        description_id: 'Pusat orchestration AI yang mengoordinasikan semua agen, mengelola memori, dan mengeksekusi workflow otomatis. 1ai-hub adalah sistem saraf pusat BerkahKarya — menghubungkan setiap layanan, menyimpan konteks, dan memastikan setiap bagian bekerja selaras. Dari menjadwalkan konten sosial media hingga mengeksekusi otomasi bisnis, semuanya melewati hub ini.',
        description_en: 'The central AI orchestration hub that coordinates all agents, manages memory, and executes automated workflows. 1ai-hub is the central nervous system of BerkahKarya — connecting every service, storing context, and ensuring every component works in harmony. From scheduling social media content to executing business automation, everything flows through this hub.',
        emoji: '🧠',
        status: 'live',
        features: [
          { icon: '🤖', title_id: 'Multi-Agent Orchestration', title_en: 'Multi-Agent Orchestration', desc_id: '30+ agen AI khusus berjalan simultan — content creator, advertiser, analyst, automation specialist. Masing-masing punya peran, tools, dan memori sendiri.', desc_en: '30+ specialized AI agents running simultaneously — content creator, advertiser, analyst, automation specialist. Each has its own role, tools, and memory.' },
          ...
          { icon: '⚡', title_id: 'Workflow Automation', title_en: 'Workflow Automation', desc_id: 'Rantai aksi otomatis: trigger → decision → eksekusi. Contoh: order masuk → verifikasi payment → kirim akses → follow up otomatis.', desc_en: 'Automated action chains: trigger → decision → execution. Example: order comes in → payment verification → send access → automatic follow-up.' },
          { icon: '🔄', title_id: 'Cross-Service Integration', title_en: 'Cross-Service Integration', desc_id: 'Semua layanan (1ai, OmniRoute, ads, AI studio) terhubung dan berbagi data real-time melalui hub pusat.', desc_en: 'All services (1ai, OmniRoute, ads, AI studio) are connected and share real-time data through the central hub.' },
      ...
      {
        slug: '1ai-workflow',
        name_id: '1AI-Workflow',
        name_en: '1AI-Workflow',
        tagline_id: 'Otomasi Bisnis Tanpa Batas',
        tagline_en: 'Unlimited Business Automation',
        description_id: 'Sistem otomasi workflow bisnis end-to-end. Dari lead generation, content scheduling, customer service, sampai sales follow-up — semua berjalan otomatis dengan AI agent隨時.',
        description_en: 'End-to-end business workflow automation system. From lead generation, content scheduling, customer service, to sales follow-up — all running automatically with AI agent.',
        emoji: '⚡',
        status: 'live',
        features: [
          { icon: '🔄', title_id: 'Auto Workflow Engine', title_en: 'Auto Workflow Engine', desc_id: 'Trigger → decision → eksekusi. Semua workflow berjalan tanpa campur tangan manual. Trigger dari webhook, form, atau scheduled job.', desc_en: 'Trigger → decision → execution. All workflows run without manual intervention. Triggered from webhook, form, or scheduled jobs.' },
          { icon: '🤖', title_id: 'Multi-Agent System', title_en: 'Multi-Agent System', desc_id: 'Beberapa AI agent bekerja bersama — masing-masing punya expertise tersendiri, saling terkoordinasi lewat hub central.', desc_en: 'Multiple AI agents working together — each with their own expertise, coordinated seamlessly via central hub.' },
          { icon: '📊', title_id: 'Real-time Monitoring', title_en: 'Real-time Monitoring', desc_id: 'Dashboard监控 semua workflow yang berjalan. Log lengkap, alert otomatis, zero blind spot. Transparan penuh.', desc_en: 'Dashboard监控 all running workflows. Complete logs, automatic alerts, zero blind spot. Full transparency.' },
          { icon: '🔗', title_id: 'API & Integration', title_en: 'API & Integration', desc_id: 'Terhubung ke semua layanan: Telegram, WhatsApp, email, spreadsheet, database, payment gateway. Unlimited possibilities.', desc_en: 'Connected to all services: Telegram, WhatsApp, email, spreadsheet, database, payment gateway. Unlimited possibilities.' },
        ],
      },
    ],
    stats: [
