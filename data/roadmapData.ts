  ...
  id: {
    ...
    phases: [
      ...
      },
      {
        ...
        items_id: [
          'Veris AI (The Dream) — AI eksekutif yang bisa coding, trading, advertise, negosiasi, dan menjalankan seluruh bisnis secara otonom. CEO buatan yang sesungguhnya.',
        ...
        items_en: [
          'Veris AI (The Dream) — An AI executive that can autonomously code, trade, advertise, negotiate, and run the entire business. A true autonomous CEO.',
